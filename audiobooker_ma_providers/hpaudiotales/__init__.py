"""MA provider for HP Audio Tales."""
...
async def setup(
    ...
    return HpaudiotalesProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.hpaudiotales import HPTalesAudioBooks  # noqa: PLC0415
    return HPTalesAudioBooks()


class HpaudiotalesProvider(AudiobookerProviderBase):
    """MA provider for HP Audio Tales."""
