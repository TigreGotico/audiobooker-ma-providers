...
async def setup(
    ...
    return HorrorbabbleProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.youtube import HorrorBabble  # noqa: PLC0415
    return HorrorBabble()


class HorrorbabbleProvider(AudiobookerProviderBase):
    """MA provider for HorrorBabble."""
