"""MA provider for Golden Audiobooks."""
...
async def setup(
    ...
    return GoldenaudiobooksProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.goldenaudiobooks import GoldenAudioBooks  # noqa: PLC0415
    return GoldenAudioBooks()


class GoldenaudiobooksProvider(AudiobookerProviderBase):
    """MA provider for Golden Audiobooks."""
