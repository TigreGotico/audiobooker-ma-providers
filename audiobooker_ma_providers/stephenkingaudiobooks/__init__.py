"""MA provider for Stephen King Audiobooks."""
...
async def setup(
    ...
    return StephenkingaudiobooksProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.stephenkingaudiobooks import StephenKingAudioBooks  # noqa: PLC0415
    return StephenKingAudioBooks()


class StephenkingaudiobooksProvider(AudiobookerProviderBase):
    """MA provider for Stephen King Audiobooks."""
