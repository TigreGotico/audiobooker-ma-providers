...
async def setup(
    ...
    return LoyalbooksProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.loyalbooks import LoyalBooks  # noqa: PLC0415
    return LoyalBooks()


class LoyalbooksProvider(AudiobookerProviderBase):
    """MA provider for LoyalBooks."""
