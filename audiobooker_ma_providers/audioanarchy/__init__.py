...
async def setup(
    ...
    return AudioanarchyProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.audioanarchy import AudioAnarchy  # noqa: PLC0415
    return AudioAnarchy()


class AudioanarchyProvider(AudiobookerProviderBase):
    """MA provider for Audio Anarchy."""
