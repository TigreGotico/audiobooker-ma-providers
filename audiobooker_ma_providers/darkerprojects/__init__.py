"""MA provider for Darker Projects."""
...
async def setup(
    ...
    return DarkerprojectsProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.darkerprojects import DarkerProjects  # noqa: PLC0415
    return DarkerProjects()


class DarkerprojectsProvider(AudiobookerProviderBase):
    """MA provider for Darker Projects."""
