...
async def setup(
    ...
    return LibrivoxProvider(mass, manifest, config, SUPPORTED_FEATURES)
...
def _get_source():
    from audiobooker.scrappers.librivox import Librivox  # noqa: PLC0415
    return Librivox()


class LibrivoxProvider(AudiobookerProviderBase):
    """MA provider for Librivox."""
